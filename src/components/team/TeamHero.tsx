...
const TeamHero = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-5 h-[500px] md:h-[500px] xl:h-[500px]">
      <div className="bg-cover col-span-3">
      ...
      <div className="col-span-2 border-b-2 border-ace-black flex flex-col justify-center pl-8 py-6 pr-4">
        <h2 className="text-3xl lg:text-4xl xl:text-5xl">
          ...
          <span className="md:block md:pl-16">Compelling </span>
          <span className="">Videos for </span>
          <span className="md:block md:pl-16">Businesses </span>
